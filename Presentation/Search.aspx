<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="THE_PROJECT_E_PERSONAL.Search" %>
...
<table class="style1">
        <tr>
            <td class="style2">
                <asp:Image ID="Image1" runat="server" Height="66px" 
                    ImageUrl="~/Resources/Search-Computer.png" Width="70px" />
            </td>
            <td class="style3">
                <span class="style4">****<asp:Label ID="Label8" runat="server" 
                    style="font-family: 'Square721 BT'; font-size: small; color: #CCCCCC; " 
                    Text="Search for Employee" BorderStyle="Groove" BorderWidth="1px"></asp:Label>
                ****</span></td>
            <td class="style5">
                &nbsp;</td>
            <td>
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
                <font size="4" face="Square721 BT" color="pink"><marquee behavior=SCROLL scrollamount="3" HEIGHT=25 WIDTH=300 BGColor=#336699>Enter the unique code of the employee you would like to view information and then press FIND</marquee></font>
            <td class="style3">
                &nbsp;</td>
            <td class="style5">
                &nbsp;</td>
